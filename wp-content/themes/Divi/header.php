...
?>
	...
	<?php wp_head(); ?>
<meta name="geo.placename" content="388 Main St #2f, Monroe, CT 06468, USA" />
			...
			<?php if ( $et_contact_info_defined ) : ?>
				...
				<?php if ( '' !== ( $et_phone_number = et_get_option( 'phone_number' ) ) ) : ?>
					<span id="et-info-phone">
						<a href="tel:<?php echo et_sanitize_html_input_text( $et_phone_number ); ?>" onClick="__gaTracker('send', 'event', 'Phone Number', 'Click to Call', '<?php echo et_sanitize_html_input_text( $et_phone_number ); ?>');"><?php echo et_sanitize_html_input_text( $et_phone_number ); ?>
						</a>
					</span>
				<?php endif; ?>
