...
<div class="feature-section one-col">
    <div class="col">
        <p>FIX: Optional loading of Font Awesome.</p>
        <p>FIX: Width on double-digit pagination controls in Modern template.</p>
        <p>FIX: Hide slider controls if no slides are present.</p>
        <p>FIX: CSS for slider controls in Internet Explorer 11.</p>
